...
<html lang="en">
    <head>
        ...
        <title>UniSched USM: Map - Health Campus</title>
    </head>
    <body id="page-top">
        <div id="wrapper">
            <!-- side bar -->
            <ul class="navbar-nav bg-white sidebar" id="accordionSidebar">
                ...
                <li class="nav-item active">
                    ...
                    <div class="bg-primary py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item text-white active" href="../student/map_health-campus.php">Health Campus</a>
                    </div>
                </div>
                </li>
                <hr class="sidebar-divider">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="ml-4 d-sm-inline-block">
                            <a href="../map/usm-map-health.pdf" class="btn btn-info" target="_blank">
